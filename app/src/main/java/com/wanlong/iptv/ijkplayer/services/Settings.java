...
package com.wanlong.iptv.ijkplayer.services;
...
//        }
    ...
    public static boolean mediaCodec;

    public static void setMediaCodec(boolean usemediaCodec) {
        mediaCodec = usemediaCodec;
    }
