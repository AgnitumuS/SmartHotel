...
/**
 * Created by lingchen on 2018/5/21. 09:29
...
//            PrintWriter.println("sleep 1; am start -n " + "com.wanlong.iptv/.ui.activity.StartActivity");//安装完成后重启
    ...
    public static boolean startApp(String packageName, String activityName) {
        ...
        String cmd = "sleep 20; am start -n " + packageName + "/" + activityName + " \n";
        Process process = null;
        try {
    ...
    public static void execLinuxCommand(String packageName, String activityName) {
        String cmd = "sleep 12; am start -n " + packageName + "/" + activityName;
        //Runtime对象
        ...
        try {
            ...
            Log.i("execLinuxCommand", "strLine:" + e.getMessage());
            e.printStackTrace();
        }
    }
