...
import com.wanlong.hotel.mvp.LivePresenter;
import com.wanlong.hotel.player.LiveVideoPlayer;
import com.wanlong.hotel.player.SimpleVideoCallBack;
import com.wanlong.hotel.ui.adapter.LiveCategoryAdapter;
import com.wanlong.hotel.ui.adapter.LiveListAdapter;
...
//        getPresenter().loadLiveData("");
    ...
    private void initPlayer() {
        ...
        mLiveVideoPlayer.setUp("http://192.168.1.201/earth1.mp4", false, "");
        mLiveVideoPlayer.startPlayLogic();
        mLiveVideoPlayer.setIsTouchWigetFull(true);
        mLiveVideoPlayer.setStandardVideoAllCallBack(new SimpleVideoCallBack() {
            @Override
